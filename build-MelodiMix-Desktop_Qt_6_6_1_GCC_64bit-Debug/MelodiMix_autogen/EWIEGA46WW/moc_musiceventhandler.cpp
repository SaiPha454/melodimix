...
constexpr auto qt_meta_stringdata_CLASSMusicEventHandlerENDCLASS = QtMocHelpers::stringData(
    "MusicEventHandler",
    "onMusicItemClicked",
    "",
    "QListWidgetItem*",
...
void MusicEventHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onSetPlayerPostion((*reinterpret_cast< std::add_pointer_t<qint64>>(_a[1]))); break;
        default: ;
        }
    }
}
